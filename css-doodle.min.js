!function (e) {
    ...
    function d(e, t) {
        let n, r = o.step();
        for (; !e.end() && "}" != (n = e.curr());) if (u.white_space(n)) e.next(); else {
            if (r.name.length) {
    ...
    function _(e) {
        let t, n = [], r = [], i = [], l = "";
        for (; !e.end();) {
            if (t = e.curr(), /[\('"`]/.test(t) && "\\" !== e.curr(-1)) i.length && "(" != t && t === s(i) ? i.pop() : i.push(t), l += t; else if ("@" == t) r.length || (l = l.trimLeft()), l.length && (r.push(o.text(l)), l = ""), r.push(b(e)); else if (/[,)]/.test(t)) {
                if (i.length) ")" == t && i.pop(), l += t; else if (l.length && (r.length ? l.length && r.push(o.text(l)) : r.push(o.text((a = l).trim().length ? u.number(+a) ? +a : a.trim() : a))), n.push(v(r)), [r, l] = [[], ""], ")" == t) break
            } else l += t;
            e.next()
        }
        var a;
    ...
    function $(e) {
        let t, n = o.text(), r = 0, s = !0;
        const i = [], l = [];
        for (i[r] = []; !e.end();) if (t = e.curr(), s && u.white_space(t)) e.next(); else {
            if (s = !1, "\n" != t || u.white_space(e.curr(-1))) if ("," != t || l.length) {
                if (/[;}]/.test(t)) {
            ...
            } else n.value.length && (i[r].push(n), n = o.text()), i[++r] = [], s = !0; else n.value += " ";
            e.next()
        }
    ...
    function z(e) {
        ...
        for (; !e.end();) {
            if ("(" == (t = e.curr())) e.next(), n.arguments = _(e); else {
                if (/[){]/.test(t)) break;
    ...
    function A(e, t) {
        ...
        for (; !e.end() && "}" != (n = e.curr());) {
            ...
            } else r.styles.push(A(e)); else Object.assign(r, z(e));
            e.next()
        }
        return r
    }
    ...
    function E(t, n) {
        ...
        for (; !r.end();) {
            let e = r.curr();
            if (u.white_space(e)) r.next(); else {
    ...
    function L(e, t, n) {
        ...
        let o = [];
        for (; (n >= 0 && e <= t || n < 0 && e > t) && (o.push(e), e += n, !(r++ >= 1e3));) ;
    ...
    const [R, I, D] = [1, 32, 1024];

    function P(e) {
        let [t, n, r] = (e + "").replace(/\s+/g, "").replace(/[,，xX]+/g, "x").split("x").map(Number);
        const s = 1 == t || 1 == n ? D : I, i = 1 == t && 1 == n ? D : R,
            l = {x: O(t || R, 1, s), y: O(n || t || R, 1, s), z: O(r || R, 1, i)};
        return Object.assign({}, l, {count: l.x * l.y * l.z})
    }
        ...
        const t = function (e) {
            let t = function (e) {
                ...
                for (let e = 0; e < t.length; ++e) {
                    let i = t[e];
                    if (F[i]) if ("-" == i && "e" == t[e - 1]) r += i; else if (n.length || r.length || !/[+-]/.test(i)) {
    ...
    const ee = K("build_range", e => {
        return l(function (e) {
            ...
            for (let e = 1; e < t.length - 1; ++e) {
                let i = t[e];
                if ("-" != i || "-" != t[e - 1]) if ("-" != i) if ("-" != s(r)) r.length && n.push(Y("char", r.pop())), r.push(i); else {
                    r.pop();
                    let e = r.pop();
    ...
    }), {cos: te, sin: ne, sqrt: re, pow: se, PI: ie} = Math, le = ie / 180;

    function oe(e, t) {
        "function" == typeof arguments[0] && (t = e, e = {}), t || (t = (e => [te(e), ne(e)]));
        let n = e.split || 120, r = e.scale || 1, s = le * (e.start || 0), i = e.deg ? e.deg * le : ie / (n / 2),
            l = [];
        for (let e = 0; e < n; ++e) {
            let n = s + i * e, [o, u] = t(n);
    ...
    const ae = {
        circle: () => "circle(49%)",
        triangle: () => oe({split: 3, start: -90}, e => [1.1 * te(e), 1.1 * ne(e) + .2]),
        rhombus: () => oe({split: 4}),
        pentagon: () => oe({split: 5, start: 54}),
        hexgon: () => oe({split: 6, start: 30}),
        hexagon: () => oe({split: 6, start: 30}),
        heptagon: () => oe({split: 7, start: -90}),
        octagon: () => oe({split: 8, start: 22.5}),
        star: () => oe({split: 5, start: 54, deg: 144}),
        diamond: () => "polygon(50% 5%, 80% 50%, 50% 95%, 20% 50%)",
        cross: () => "polygon(\n 5% 35%, 35% 35%, 35% 5%, 65% 5%,\n 65% 35%, 95% 35%, 95% 65%, 65% 65%,\n 65% 95%, 35% 95%, 35% 65%, 5% 65%\n )",
        clover: (e = 3) => (4 == (e = O(e, 3, 5)) && (e = 2), oe({split: 240}, t => {
            let n = te(e * t) * te(t), r = te(e * t) * ne(t);
            return 3 == e && (n -= .2), 2 == e && (n /= 1.1, r /= 1.1), [n, r]
        })),
        hypocycloid(e = 3) {
            let t = 1 - (e = O(e, 3, 6));
            return oe({scale: 1 / e}, n => {
                let r = t * te(n) + te(t * (n - ie)), s = t * ne(n) + ne(t * (n - ie));
                return 3 == e && (r = 1.1 * r - .6, s *= 1.1), [r, s]
            })
        },
        astroid: () => ae.hypocycloid(4),
        infinity: () => oe(e => {
            let t = .7 * re(2) * te(e), n = se(ne(e), 2) + 1;
            return [t / n, t * ne(e) / n]
        }),
        heart: () => oe(e => {
        ...
        whale: () => oe({split: 240}, e => {
            let t = 3.4 * (se(ne(e), 2) - .5) * te(e);
            return ue(te(e) * t + .75, ne(e) * t * 1.2, 180)
        }),
        bud: (e = 3) => (e = O(e, 3, 10), oe({split: 240}, t => [(1 + .2 * te(e * t)) * te(t) * .8, (1 + .2 * te(e * t)) * ne(t) * .8])),
        alien(...e) {
        ...
        "size-depth": ({grid: e}) => t => e.z,
        n: ({idx: e}) => t => e || 0,
        pick: ({context: e}) => Q((...t) => e.last_pick = function (...e) {
        ...
        "pick-n"({idx: e, context: t, position: n}) {
            ...
            return Q((...n) => {
                t[r] || (t[r] = 0), t[r] += 1;
                let s = n.length, i = ((void 0 === e ? t[r] : e) - 1) % s;
        ...
        "pick-d"({idx: e, context: t, position: n}) {
            ...
            return Q((...n) => {
                ...
                let i = n.length, l = ((void 0 === e ? t[r] : e) - 1) % i;
        ...
        rand: ({context: e}) => (...t) => {
            let n = (t.every(T) ? V : Z)(B).apply(null, t);
            return e.last_rand = n
        },
        "rand-int": ({context: e}) => (...t) => {
            let n = t.every(T) ? V : Z, r = parseInt(n(B).apply(null, t));
    ...
    var ke = {
        "@size"(e, {is_special_selector: t}) {
            ...
            let e = {center: "50%", 0: "0%", left: "0%", right: "100%", top: "50%", bottom: "50%"},
                t = {center: "50%", 0: "0%", top: "0%", bottom: "100%", left: "50%", right: "50%"};
            return n => {
                let [r, s = "50%"] = me(n);
    ...
    function ze(e, t, n) {
        ...
        for (let e = 0; e <= n; ++e) if (X(r(e)) == t) return !0
    }
    ...
    var Ae = {
        ...
        nth: ({count: e, grid: t}) => (...n) => n.some(n => je(n) ? we[n](e - 1) : ze(n, e, t.count)),
        row: ({x: e, grid: t}) => (...n) => n.some(n => je(n) ? we[n](e - 1) : ze(n, e, t.x)),
        col: ({y: e, grid: t}) => (...n) => n.some(n => je(n) ? we[n](e - 1) : ze(n, e, t.y)),
        even: ({count: e}) => t => we.even(e - 1),
        odd: ({count: e}) => t => we.odd(e - 1),
        random: () => (e = .5) => (e >= 1 && e <= 0 && (e = .5), Math.random() < e)
    };
    var Me = Object.getOwnPropertyNames(Math).reduce((e, t) => (e[t] = (() => (...e) => "number" == typeof Math[t] ? Math[t] : Math[t].apply(null, e.map(X))), e), {});
    ...
    class Oe {
        ...
        compose_rule(e, t, n) {
            ...
            let o = `${s}:${l};`;
            if (o = $e(s, o), "clip-path" == s && (o += ";overflow:hidden;"), "width" != s && "height" != s || Ce(n) || (o += `--internal-cell-${s}:${l};`), ke[s]) {
                let t = ke[s](l, {is_special_selector: Ce(n)});
                switch (s) {
                    case"@grid":
    ...
    function Le(e, t) {
        let n = new Oe(e), r = {};
        n.compose({x: 1, y: 1, z: 1, count: 1, context: {}, grid: {x: 1, y: 1, z: 1, count: 1}});
        let {grid: s} = n.output();
        if (s && (t = s), n.reset(), 1 == t.z) for (let e = 1, s = 0; e <= t.x; ++e) for (let i = 1; i <= t.y; ++i) n.compose({
            x: e,
            y: i,
            z: 1,
            count: ++s,
            grid: t,
            context: r
        }); else for (let e = 1, s = 0; e <= t.z; ++e) n.compose({x: 1, y: 1, z: e, count: ++s, grid: t, context: r});
        return n.output()
    }
    ...
    customElements.define("css-doodle", class extends HTMLElement {
        ...
        connectedCallback() {
            setTimeout(() => {
                ...
                try {
                    ...
                    this.grid_size = P(this.getAttribute("grid")), (e = Le(n, this.grid_size)).grid && (this.grid_size = e.grid), this.build_grid(e)
                } catch (e) {
        ...
        html_cells() {
            let {x: e, y: t, z: n} = this.grid_size, r = [];
            if (1 == n) for (let n = 1; n <= e; ++n) for (let e = 1; e <= t; ++e) r.push(`<div id="${W(n, e, 1)}"></div>`); else {
                for (let e = 1; e <= n; ++e) r.push(`<div id="${W(1, 1, e)}">`);
                r.push("</div>".repeat(n))
            }
            return r.join("")
        }
        ...
        update(e) {
            ...
            const n = Le(E(t + e, this.extra), this.grid_size);
            if (n.grid) {
                ...
                let n = P(this.getAttribute("grid")), {x: r, y: s, z: i} = n, {x: l, y: o, z: u} = this.grid_size;
                if (l !== r || o !== s || u !== i) return Object.assign(this.grid_size, n), this.build_grid(Le(E(t + e, this.extra), this.grid_size))
            }
